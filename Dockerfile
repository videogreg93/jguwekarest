...
mv /tmp/jprofiler_linux_11_0.tar.gz  /opt &&\
chmod 777 /opt/jprofiler_linux_11_0.tar.gz  &&\
tar -xzf /opt/jprofiler_linux_11_0.tar.gz -C /usr/local &&\
rm /opt/jprofiler_linux_11_0.tar.gz 
ENV JPAGENT_PATH="-agentpath:/usr/local/jprofiler11/bin/linux-x64/libjprofilerti.so=nowait"
